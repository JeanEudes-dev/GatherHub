...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const user = await login({ username: usernameOrEmail, password });
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] py-12">
      <Card className="w-full max-w-md glass-card"> {/* Apply glass-card style */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" // Placeholder for forgot password functionality
        ...
        <CardFooter className="text-center block">
          <p className="text-sm text-gray-300">
            ...
            <Link to="/register" className="font-medium text-aurora-purple hover:underline">
              Sign up
            </Link>
          </p>
        </CardFooter>
