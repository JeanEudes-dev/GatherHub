...
interface AuthState {
  ...
  updateProfile: (
    profileData: UpdateProfileData | FormData
  ) => Promise<User | null>
    ...
    (set, get) => ({
      ...
      login: async credentials => {
        ...
        try {
          ...
          const newAccessToken = localStorage.getItem('access') // Fetched by apiLogin's interceptor
          const newRefreshToken = localStorage.getItem('refresh')
